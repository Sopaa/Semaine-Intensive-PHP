...
<?php
/* Not functional yet => Sends back an error message if edit or add returns index.php with an error in URL  */
...
?>
        <!-- While $row is not nul, returns tab indexed by the column name -->
