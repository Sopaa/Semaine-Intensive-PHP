...
<body>
  <div class="content">
    ...
    <div class="itemsContainer">
      <!-- <div class="edit">
          <div class="edit1">
            <a href="details.php"><img class="img" src="img/agneau.jpg" alt=""></a>
            <a href="edit.php"><img class="setting" src="img/setting.png" alt="setting"></a>
          </div>
          <div class="edit2">
            <p class="productName">Nom</p>
            <a href="delete.php"><img class="setting" src="img/garbage.png" alt="setting"></a>
          </div>
        </div> -->
